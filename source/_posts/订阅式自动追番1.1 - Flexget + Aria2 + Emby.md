...
> 比如https://bangumi.moe/search/**615bb91fd7f73dd4ed5c4405**+**58a9c1e6f5dc363606ab42ed**，
> 
> 通过链接里加粗体的标签字符串，获取番剧详细信息，此处代替了本应连接tmdb获取的信息。
...
##### UpdateConfig.py(更新项目时被[UpdateRSS.sh](#UpdateRSS.sh)调用)
```py
#！/user/bin/python3
## 更新flexget配置文件
import os
